    ...
    return (
        <section className="space-y-3">
          ...
          <p className="text-zinc-700 leading-relaxed">
            I design systems & experiences that work for people, not the other way around. 
            I believe good design should step in quietly to reduce friction, streamline workflows, 
